...
var require_semver = __commonJS({
  "node_modules/semver/semver.js"(exports2, module2) {
    ...
    function SemVer(version3, options) {
      ...
      var m3 = version3.trim().match(options.loose ? re[t2.LOOSE] : re[t2.FULL]);
      if (!m3) {
        throw new TypeError("Invalid Version: " + version3);
      }
      this.raw = version3;
    ...
    function coerce(version3, options) {
      ...
      var match2 = null;
      if (!options.rtl) {
        match2 = version3.match(re[t2.COERCE]);
      } else {
        var next;
        while ((next = re[t2.COERCERTL].exec(version3)) && (!match2 || match2.index + match2[0].length !== version3.length)) {
...
var OpenActionContext = class {
  ...
  async getEscapePath() {
    let path2 = await this.getFullpath();
    if (this.explorer.config.get("openAction.relativePath")) {
      path2 = await import_coc33.workspace.nvim.call("fnamemodify", [path2, ":."]);
    }
    return await import_coc33.workspace.nvim.call("fnameescape", [path2]);
  }
  async tryResize() {
