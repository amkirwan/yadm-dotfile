# Generated by Powerlevel10k configuration wizard on 2020-04-07 at 15:34 CDT.
...
# dotted, left frame, light-ornaments, compact, many icons, concise, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH && -n $VCS_STATUS_TAG ]]; then
      res+="${clean} ${(g::)POWERLEVEL9K_VCS_TAG_ICON}${VCS_STATUS_TAG}"
    fi
